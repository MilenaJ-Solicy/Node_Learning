...
<p>Since find consumes a prefix of the
enumeration, it can be used several times on the same enumeration to find
the next element.</p>
</div></div></article><article id="Enum.prototype.iter" data-title="Enum#iter (instance method)" class="docblock"><header><ul class="breadcrumbs"><li><a href="#home">Home</a></li><li><a href="#Enum" class="" title="Enum (namespace)" data-id="enum">Enum</a></li><li><a href="#Enum.prototype.iter" class="" title="Enum#iter (instance method)" data-id="enum#iter">iter</a></li></ul><div class="type">instance method</div><h2><span class="name_prefix">Enum#</span>iter</h2></header><div class="section method"><div class="content"><ul class="signatures"><li><ul class="signature"><li class="signature-call">Enum#iter(function)</li></ul></li></ul><p><code>e.iter(f)</code> calls the function f with each element of e in turn. This
consumes the enumeration.</p>
</div></div></article><footer class="footer"><p>Last updated on Thu, 29 Nov 2012 22:45:33 GMT. Generated by <a href="http://github.com/nodeca/ndoc">ndoc</a></p></footer></div></body></html>